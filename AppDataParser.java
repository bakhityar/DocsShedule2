...
public class AppDataParser {
    ...
    public static void main(String[] args) {
        ...
        //Вывод в консоль конечного массива после обработки методом normalizeGrafic
        System.out.println(Arrays.deepToString(normalizeGrafic(data)));

    }


    public static String[][] normalizeGrafic(String[][] data) {
        ...
        for (int i = 1; i < data.length; i++) {
            ...
            for (int j = 0; j < result_length; j++) {
                ...
                if ((yes)) {
                    for (int k = 1; k < data[0].length; k++) {   //Если одно из полей пустое, просто присваиваем его без всяких условий
